...
and procedures that could be vectorized but are not.
...
\ref{lst:copy_compiled}. To do so more effectively, we will start from the top of the code snippets collection from \texttt{TSVC}\footnote{\url{https://github.com/UoB-HPC/TSVC_2/blob/master/src/tsvc.c}} that contains
various vectorizable pieces of code, ranging from trivial sum of vectors to more intricated and convoluted operations.
